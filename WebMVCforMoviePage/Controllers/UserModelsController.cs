...
namespace WebMVCforMoviePage.Controllers
{
    public class UserModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,Phone,Role,SubcriptionStatus")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password,Phone,Role,SubcriptionStatus")] UserModel userModel)
        {
            if (id != userModel.Id)
            {
                return NotFound();
