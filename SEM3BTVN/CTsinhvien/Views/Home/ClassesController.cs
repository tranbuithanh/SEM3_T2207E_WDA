...
namespace CTsinhvien.Views.Home
{
    public class ClassesController : Controller
    {
        private readonly Sem3MvcContext _context;

        public ClassesController(Sem3MvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Classes != null ? 
                          ...
                          Problem("Entity set 'Sem3MvcContext.Classes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sem3MvcContext.Classes'  is null.");
            }
            var @class = await _context.Classes.FindAsync(id);
            if (@class != null)
            {
